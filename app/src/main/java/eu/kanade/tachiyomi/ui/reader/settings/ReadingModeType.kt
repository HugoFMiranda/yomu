...
// Kept outside the companion: enum entry initializers run before the
// companion object exists, and K2 rejects reading it that early
private const val READING_MODE_SHIFT = 0x00000000
